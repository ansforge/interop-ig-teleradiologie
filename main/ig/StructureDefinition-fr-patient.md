# Patient français - Volet Téléradiologie v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/hl7v2/teleradiologie/StructureDefinition/fr-patient | *Version*:0.1.0 |
| Draft as of 2025-11-06 | *Computable Name*:FrPatient |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ans.hl7v2.fr.teleradiologie|current/StructureDefinition/fr-patient)
...
```json
{
  ...
  "id" : "fr-patient",
  "url" : "https://interop.esante.gouv.fr/ig/hl7v2/teleradiologie/StructureDefinition/fr-patient",
  "version" : "0.1.0",
  "name" : "FrPatient",
  ...
  "differential" : {
    "element" : [
        ...
        "type" : [
          {
            "code" : "Extension",
            "profile" : [
              "https://interop.esante.gouv.fr/ig/hl7v2/teleradiologie/StructureDefinition/EyeColor"
            ]
          }
        ],
        "mustSupport" : true
      ...
      },
      {
        ...
        "binding" : {
          "strength" : "required",
          "valueSet" : "https://interop.esante.gouv.fr/ig/hl7v2/teleradiologie/ValueSet/ModifiedAdministrativeGender"
        }
      }
    ]
  }
